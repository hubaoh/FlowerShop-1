...
<%String s=(String)request.getParameter("usersId");
//System.out.println(s+"  #######");
if(s!=null)
{
	userBean.deleteUser(s);
}

Collection users=userBean.getAllUserInfo();
...
while(it.hasNext())
{
   ...
   {}
		out.println("<td><div align=center class=style13><a href='viewAllusers.jsp?usersId="+user.getUsersId()+"'>删除</a></div></td>");
	out.println("</tr>");
}
