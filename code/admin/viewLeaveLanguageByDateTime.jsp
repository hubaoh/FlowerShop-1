...
<%
String year=(String)request.getParameter("select");
String month=(String)request.getParameter("select2");
String day=(String)request.getParameter("select3");
Collection language=leaveLanguageBean.getLanguageByDateTime(year,month,day);
