...
<tr bgcolor="#00addf" bordercolor="#00addf">
<td width="11%"><div align="center" class="style4 style5"><strong>订单号</strong></div></td>
...
<%
String userName=(String)request.getParameter("category2");
Collection order=cart.getOrdersByUserName(userName);
...
while(it.hasNext())
{
	...
	out.println("<td><div align=center class=style13><a href='deleteOrderSuccess.jsp?ordersId="+orders.getOrdersId()+"'>删除</a></div></td>");
	out.println("</tr>");
}
