...
A:hover { COLOR: #99d767; FONT-SIZE: 12px; TEXT-DECORATION: none}
...
function showitem(id,name)
{
	if(name=='退出管理系统')
	{
		return ("<span><a href='"+id+"' target=_top><br><img src=exit.JPG border=0><br>"+name+"</a></span><br>")
	}
	else
	{
...
// outlookbar.otherclass="bgcolor=#cccccc border=0 cellspacing=0 cellpadding=0 style='height:100%;width:100%;' valign=middle align=left "; 
</SCRIPT>
...
<td width="15" bgcolor=#FFFFFF background="menu_bg_02.gif"> 
<table cellspacing=0 cellpadding=0 border=0>
<tr> 
<td width="10" align=middle valign=center> <span class=np id=switchPoint onClick=switchSysBar() title="打开/关闭导航">3</span></td>
</tr>
</table>
</td>
</tr>
